...
class FeatureStream:
    def __init__(self, sum_track: SumTrack, input_features: list[InputFeature], label_features: list[LabelFeature], settings: Settings) -> None:
        ...
        self._maximum_number_of_samples = math.ceil(settings.training_mux_number_of_samples_per_sum_track_minute * sum_track.n_frames * settings.hop_length / (settings.sr * 60))
